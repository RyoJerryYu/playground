...
func (m *SignInWithSSORequest) validate(all bool) error {
	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, SignInWithSSORequestValidationError{
					field:  "Nested",
					reason: "embedded message failed validation",
					cause:  err,
				})
...
// Validate checks the field values on SignInWithSSORequest_Nested with the
// rules defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *SignInWithSSORequest_Nested) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on SignInWithSSORequest_Nested with the
// rules defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// SignInWithSSORequest_NestedMultiError, or nil if none found.
func (m *SignInWithSSORequest_Nested) ValidateAll() error {
	return m.validate(true)
}

func (m *SignInWithSSORequest_Nested) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return SignInWithSSORequest_NestedMultiError(errors)
	}

	return nil
}

// SignInWithSSORequest_NestedMultiError is an error wrapping multiple
// validation errors returned by SignInWithSSORequest_Nested.ValidateAll() if
// the designated constraints aren't met.
type SignInWithSSORequest_NestedMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m SignInWithSSORequest_NestedMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m SignInWithSSORequest_NestedMultiError) AllErrors() []error { return m }

// SignInWithSSORequest_NestedValidationError is the validation error returned
// by SignInWithSSORequest_Nested.Validate if the designated constraints
// aren't met.
type SignInWithSSORequest_NestedValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e SignInWithSSORequest_NestedValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e SignInWithSSORequest_NestedValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e SignInWithSSORequest_NestedValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e SignInWithSSORequest_NestedValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e SignInWithSSORequest_NestedValidationError) ErrorName() string {
	return "SignInWithSSORequest_NestedValidationError"
}

// Error satisfies the builtin error interface
func (e SignInWithSSORequest_NestedValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sSignInWithSSORequest_Nested.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = SignInWithSSORequest_NestedValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = SignInWithSSORequest_NestedValidationError{}
