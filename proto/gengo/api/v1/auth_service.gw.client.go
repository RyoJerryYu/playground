...
func (c *authServiceGatewayClient) GetAuthStatus(ctx context.Context, req *GetAuthStatusRequest) (*User, error) {
	gwReq := c.gwc.NewRequest("POST", "/api/v1/auth/status")
	gwReq.SetBody(req)
	return gateway.DoRequest[User](ctx, gwReq)
}

func (c *authServiceGatewayClient) SignIn(ctx context.Context, req *SignInRequest) (*User, error) {
	gwReq := c.gwc.NewRequest("POST", "/api/v1/auth/signin")
	gwReq.SetBody(req)
	return gateway.DoRequest[User](ctx, gwReq)
}

func (c *authServiceGatewayClient) SignInWithSSO(ctx context.Context, req *SignInWithSSORequest) (*User, error) {
	gwReq := c.gwc.NewRequest("POST", "/api/v1/auth/signin/sso")
	gwReq.SetBody(req)
	return gateway.DoRequest[User](ctx, gwReq)
}

func (c *authServiceGatewayClient) SignUp(ctx context.Context, req *SignUpRequest) (*User, error) {
